...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    -Semantic HTML is html that follows a structure for the internet to read it

2. Name two big differences between ```display: block;``` and ```display: inline;```.

-display block is one big block, inline can be miltiple items
...
help many ppl work on a shared project
